            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <div className="space-y-5 text-gray-400 leading-relaxed">
                  ...
                  <p>
                    Founded by victims who experienced crypto fraud firsthand, Metatech Recovery Pro understands the emotional and financial toll of these crimes. We&apos;ve built our company around a single mission: to fight back against digital fraud and help victims reclaim what is rightfully theirs.
                  </p>
                </div>
                <div className="mt-10">
                  <Link
